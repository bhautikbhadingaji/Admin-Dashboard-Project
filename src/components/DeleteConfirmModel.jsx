...
export const DeleteConfirmModel = ({ isOpen, setIsOpen, confirmDelete }) => {

    const handeleConfirmAndCloseModel = () => {
        confirmDelete()
    }
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-400">
                        Are you sure you want to delete user? All of your data will be permanently removed.
              ...
              <div className="bg-gray-700/25 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  type="button"
                  onClick={() => handeleConfirmAndCloseModel()}
